...
\begin{proposition}
	...
	\end{center}
\end{proposition}
\section{Relationships between Stochastic Processes}
...
\end{definition}
\begin
{proposition}[properties of infinitesimal generator]
Let $f \in D(\mathcal{A})$ and $s>0$. Then $Q_s f \in D(\mathcal{A})$ and $\mathcal{A}\left(Q_s f\right)=Q_s(\mathcal{A} f)$.
\end{proposition}
